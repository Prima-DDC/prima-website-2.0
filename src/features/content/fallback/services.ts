  ...
  },
  {
    ...
    t: {
      en: {
        ...
        tagline: "Scientific proof that holds up in court, arbitration, or internal proceedings.",
        opening: [
          "Some disputes can only be settled with scientific proof. PRIMA applies forensic methodology to authenticate documents, examine digital evidence, and trace financial irregularities, turning technical findings into evidence that holds up in court, arbitration, or internal proceedings.",
          "This capability is one of PRIMA's most distinctive strengths in the region: laboratory-grade examination combined with investigative context, delivered under a documented chain of custody.",
        ],
        groups: [
          {
      ...
      fr: {
        title: "Services forensiques & Examen scientifique",
        shortTitle: "Services forensiques",
        tagline: "Des preuves scientifiques recevables devant les tribunaux et en arbitrage.",
        opening: [
          "Certains litiges ne se règlent qu'avec des preuves scientifiques. PRIMA applique une méthodologie forensique pour authentifier des documents, examiner des preuves numériques et tracer des irrégularités financières, en transformant des constats techniques en preuves recevables devant un tribunal, en arbitrage ou en procédure interne.",
          "Cette capacité est l'une des forces les plus distinctives de PRIMA dans la région : un examen de niveau laboratoire combiné au contexte d'investigation, avec une chaîne de conservation documentée.",
        ],
        groups: [
          {
      ...
      es: {
        title: "Servicios forenses y examen científico",
        shortTitle: "Servicios forenses",
        tagline: "Pruebas científicas válidas ante tribunales, arbitrajes y procedimientos internos.",
        opening: [
          "Algunas disputas solo se resuelven con pruebas científicas. PRIMA aplica metodología forense para autenticar documentos, examinar evidencia digital y rastrear irregularidades financieras, convirtiendo hallazgos técnicos en pruebas válidas ante tribunales, arbitrajes o procedimientos internos.",
          "Esta capacidad es una de las fortalezas más distintivas de PRIMA en la región: examen de nivel de laboratorio combinado con contexto investigativo, bajo una cadena de custodia documentada.",
        ],
        groups: [
          {
  ...
  },
  {
    ...
    t: {
      en: {
        ...
        shortTitle: "Insurance Solutions",
      ...
      fr: {
        ...
        shortTitle: "Solutions assurance",
      ...
      es: {
        title: "Soluciones para el sector asegurador",
        shortTitle: "Soluciones de seguros",
